...
class ResNet_34(nn.Module):
    def __init__(self, nclasses, params, block=BasicBlock, layers=[3, 4, 6, 3], if_BN=True, zero_init_residual=False,
                 norm_layer=None, groups=1, width_per_group=64, channels = [64, 128, 256]):
        ...
        self.conv1 = BasicConv2d(1, self.channels1, kernel_size=3, padding=1)
        ...
        if self.aux:
            self.aux_head1 = nn.Conv2d(self.channels2, nclasses, 1)
            self.aux_head2 = nn.Conv2d(self.channels2, nclasses, 1)
            self.aux_head3 = nn.Conv2d(self.channels2, nclasses, 1)
